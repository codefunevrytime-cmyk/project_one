...
export default function VendorAvailability() {
  ...
  // FIXED: this used to fetch ALL availability rows with no vendor
  // scoping at all (`/availability`, no vendor_id, no auth header) —
  // meaning every vendor's calendar was merged into one shared view.
  // Now it first resolves this vendor's own vendor_id (same call
  // VendorPortfolio.jsx already makes), then fetches only that
  // vendor's dates.
