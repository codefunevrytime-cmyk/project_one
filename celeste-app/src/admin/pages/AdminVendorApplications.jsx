        ...
        <div>
          {pending.length > 0 && (
            <div style={{ marginBottom: 32 }}>
              ...
              {pending.map(a => (
                <div key={a.id} className="admin-flex-row" style={{ background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 12, padding: '16px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                  <div>
          ...
          {approved.length > 0 && (
            <div>
              ...
              {approved.map(a => (
                <div key={a.id} className="admin-flex-row" style={{ background: '#fff', border: '1px solid #e8e0d5', borderRadius: 10, padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                  <div>
        ...
        <div>
          {contactRequests.length === 0 ? (
            ...
            <div key={cr.id} style={{ background: '#fff', border: '1px solid #e8e0d5', borderRadius: 12, padding: '18px 20px', marginBottom: 12 }}>
              <div className="admin-flex-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
