...
import AdminVendorDeposits from './AdminVendorDeposits';
...
const MENU = [
  { id: 'analytics',    label: 'Analytics',             icon: 'M9 19v-6a2 2 0 012-2h2a2 2 0 012 2v6m-9 0h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2zm4-9V7a1 1 0 011-1h0a1 1 0 011 1v3m4 6V9a1 1 0 011-1h0a1 1 0 011 1v7' },
  ...
  { id: 'payouts',      label: 'Vendor Payouts',       icon: 'M12 8c-1.657 0-3 .672-3 1.5S10.343 11 12 11s3 .672 3 1.5-1.343 1.5-3 1.5m0-6V6m0 9v1.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  { id: 'deposits',      label: 'Vendor Deposits',       icon: 'M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6' },
...
const SECTION_LABELS = {
  ...
  queries: 'Queries', messages: 'Messages', events: 'Event Requests', deposits: 'Vendor Deposits',
...
export default function AdminDashboard({ onLogout }) {
  ...
  const renderPage = () => {
    switch (active) {
      case 'analytics':    return <Suspense fallback={<div style={{ padding: 24 }}>Loading analytics…</div>}><AnalyticsTab /></Suspense>;
      ...
      case 'payouts':      return <AdminVendorPayouts />;
      case 'deposits':     return <AdminVendorDeposits />;
  ...
  return (
    <div className="admin-layout" style={{
      ...
      <aside className={`admin-sidebar${sidebarOpen ? ' admin-sidebar-open' : ''}`} style={{
        ...
        <div style={{
          ...
          <div style={{ minWidth: 0 }}>
            <div className="admin-logo-text" style={{ fontSize: 16, fontWeight: 700, color: '#2d2d6b', whiteSpace: 'nowrap' }}>Lumière</div>
      ...
      {/* ── Main content area ── */}
      <div className="admin-content-col" style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, height: '100vh', overflow: 'hidden' }}>
        ...
        <header className="admin-header" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
            <button
              ...
              style={{
                display: 'none', background: 'transparent', border: '1px solid #e8e8f0',
                borderRadius: 8, width: 36, height: 36, alignItems: 'center', justifyContent: 'center',
                cursor: 'pointer', flexShrink: 0, color: '#4B49AC',
              }}
            >
            ...
            <div style={{ minWidth: 0 }}>
              <div className="admin-header-title" style={{ fontSize: 17, fontWeight: 700, color: '#2d2d6b', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                {SECTION_LABELS[active]}
              </div>
              <div className="admin-header-subtitle" style={{ fontSize: 11, color: '#b0b0cc', marginTop: 1, whiteSpace: 'nowrap' }}>
        ...
        {/* Page content */}
        <main className="admin-main" style={{ flex: 1, overflowY: 'auto', padding: '24px 28px', background: '#f0f0f7' }}>
          {/* Breadcrumb */}
          <div className="admin-breadcrumb" style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 16, fontSize: 12, color: '#b0b0cc' }}>
            <span>Admin</span>
            <span>›</span>
          ...
          {/* White card wrapper */}
          <div className="admin-page-card" style={{
            background: '#fff',
            borderRadius: 12,
