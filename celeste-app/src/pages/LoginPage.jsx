...
export default function LoginPage() {
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      ...
      setToast(err.message || 'Google sign-in failed');
      setLoading(false);
    }
  };
      ...
      <div className="panel-wrap">
        ...
        <div className="panel">
          ...
          <div className="options-row">
            ...
            <button className="link-btn" type="button" onClick={() => navigate('/forgot-password')}>Forgot password?</button>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <GoogleLogin
              ...
              onError={() => setToast('Google sign-in failed')}
              theme="outline"
              size="large"
              width="360"
              shape="pill"
