  ...
  return (
    <nav>
      ...
      <ul className="nav-links">
        <li>
          <Link to="/" className={isRouteActive('/') ? 'active' : ''}>
            Home
          </Link>
        </li>
        ...
        <li>
          <Link to="/products" className={isRouteActive('/products') ? 'active' : ''}>
            Products
          </Link>
        </li>
        <li>
          <Link to="/about" className={isRouteActive('/about') ? 'active' : ''}>
            About
          </Link>
        </li>
        <li>
          <Link to="/contact" className={isRouteActive('/contact') ? 'active' : ''}>
            Contacts
          </Link>
        </li>
      </ul>
      ...
      <div className="nav-right-desktop">
        ...
        {!isLoggedIn ? (
          ...
          <div className="profile-wrap" ref={profileRef}>
            ...
            >
              <div className="avatar-circle" style={{ background: avatar.bg, color: avatar.color }}>
                {initials}
              </div>
            ...
            <div className={`celeste-dropdown${profileOpen ? ' cd-open' : ''}`}>
              <div className="cd-header">
                <div className="avatar-circle avatar-circle-lg" style={{ background: avatar.bg, color: avatar.color }}>
                  {initials}
                </div>
              ...
              <Link to="/bookmarks" className="cd-item" onClick={closeAllMenus}>
                <span className="cd-icon">
                  <svg viewBox="0 0 16 16" fill="none"><path d="M4 2h8a1 1 0 011 1v10l-5-3-5 3V3a1 1 0 011-1z" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </span>
                Bookmarked
              ...
              <button type="button" className="cd-item" onClick={() => setProfileOpen(false)}>
                <span className="cd-icon">
                  <svg viewBox="0 0 16 16" fill="none"><rect x="1.5" y="4" width="13" height="9" rx="1.5" stroke="currentColor" strokeWidth="1.3"/><path d="M1.5 7h13" stroke="currentColor" strokeWidth="1.3"/></svg>
                </span>
                Payments
              </button>
              ...
              <button type="button" className="cd-item" onClick={() => setProfileOpen(false)}>
                <span className="cd-icon">
                  <svg viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="2" stroke="currentColor" strokeWidth="1.3"/><path d="M8 1.5v2M8 12.5v2M1.5 8h2M12.5 8h2M3.4 3.4l1.4 1.4M11.2 11.2l1.4 1.4M12.6 3.4l-1.4 1.4M4.8 11.2l-1.4 1.4" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg>
                </span>
                Settings
              </button>
      ...
      <div className={`mobile-menu${mobileOpen ? ' open' : ''}`}>
        ...
        <button
          ...
          onClick={() => setMobileExploreOpen((currentValue) => !currentValue)}
        >
          Explore Events
