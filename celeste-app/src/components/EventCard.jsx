...
navigate("/create-event", {
  ...
  return (
    <div className="ep-wrap">
      <style>{`
        /* All neutral surfaces/text/borders below use the app's shared
           theme tokens (same ones EventCard.module.css / VendorListingPage.css
           consume) instead of hardcoded light-mode hex values, so this panel
           blends into both dark and light theme instead of always rendering
           as a flat white card. Amber accent hexes are kept in sync with
           var(--amber-primary)/var(--amber-bright) so hover states stay
           theme-correct too. */
        ...
        .ep-cell-label { font-size:9px; letter-spacing:1.1px; text-transform:uppercase; color:var(--text-faint); margin-bottom:4px; font-weight:600; }
        ...
        .ep-type-pill { font-size:12px; padding:5px 14px; border-radius:20px; background:var(--amber-subtle); color:var(--amber-bright); font-weight:500; border:0.5px solid var(--amber-border); }
        ...
        .ep-cta { font-family:inherit; font-size:13px; font-weight:600; background:var(--amber-primary, #D4860A); color:var(--bg-base, #0F0D0A); border:none; padding:13px 28px; border-radius:10px; cursor:pointer; transition:background 0.18s; white-space:nowrap; margin-left:auto; }
        .ep-cta:hover { background:var(--amber-bright, #c07a0a); }
        ...
        .ep-verified-badge { display:inline-flex; align-items:center; gap:4px; font-size:10px; font-weight:500; color:var(--amber-bright); background:rgba(212,134,10,0.12); padding:3px 9px; border-radius:20px; }

        /* Carousel — sits on top of the photo, translucent dark scrim reads
           fine in both themes, intentionally not tokenized */
        ...
        /* Type badge — over image, unchanged */
        ...
        /* Scale badge — over image, unchanged */
        ...
        /* Venue pin — over image, unchanged */
        ...
        /* Description */
        .ep-desc { font-size:14px; color:var(--text-muted); line-height:1.78; }

        /* Pick-mode note in footer */
        .ep-pick-note { font-size:11px; color:var(--text-faint); }
        ...
        @media (max-width: 720px) {
          ...
          .ep-img-col { min-height: 300px; height: 300px; font-size: 72px; }
          ...
          .ep-cta { width: 100%; text-align: center; margin-left: 0; }
          .ep-venue { font-size: 13px; padding: 6px 12px; }
          .ep-related-grid { grid-template-columns: repeat(2, 1fr); }
        }
        @media (max-width: 420px) {
          .ep-img-col { min-height: 220px; height: 220px; font-size: 54px; }
            ...
            <div className="ep-desc">
              {description
                ...
                : <>
                    ...
                    <strong style={{ color:"var(--text-primary)" }}>{venue}</strong> in {event.month} {event.year}.
    ...
    <>
      ...
      >
        ...
        <div className={styles.body}>
          ...
          {/* Title + Price */}
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 8, gap: 8 }}>
